...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final FoundationVersionAccessors vaccForFoundationVersionAccessors = new FoundationVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.foundation
         */
        public FoundationVersionAccessors getFoundation() {
            return vaccForFoundationVersionAccessors;
        }
    ...
    public static class FoundationVersionAccessors extends VersionFactory  {

        public FoundationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: foundation.android (1.5.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAndroid() { return getVersion("foundation.android"); }
